...
-- | __Задача #8.1.1__: реализуйте инстансы @Functor@, @Applicative@ и @Monad@
-- для @'Reader' r@. Использование @deriving@ в каком-либо виде запрещено.

-- | __Задача #8.1.2__: реализуйте функции-помощники @ask@, @local@.
...
-- | __Задача #8.2.1__: реализуйте инстансы @Functor@, @Applicative@ и @Monad@
...
-- | __Задача #8.2.2__: реализуйте функции-помощники @tell@, @listen@ и @pass@.
...
-- | __Задача #8.3.1__: реализуйте инстансы @Functor@, @Applicative@ и @Monad@
...
-- | __Задача #8.3.2__: реализуйте функции-помощники @get@, @put@.
